...
var db = require('./models/tables.js').db;
const Place = require('./models/tables.js').Place;
const Hotel = require('./models/tables.js').Hotel;
const Activity = require('./models/tables.js').Activity;
const Restaurant = require('./models/tables.js').Restaurant;
